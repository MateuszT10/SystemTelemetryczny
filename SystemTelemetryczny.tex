...
\begin{figure}[!h]
\centering
\includegraphics[width=2.79 cm, height=2.79 cm]{Obrazy/godlo_polibudy} 
\end{figure}
\\
\begin{center}
{\LARGE\textbf{Politechnika Śląska\\[0.2cm]
Wydział Automatyki, Elektroniki i Informatyki
\\[0.6cm]Kierunek Elektronika i Telekomunikacja}}
\\[2.5cm]
{\LARGE Praca dyplomowa magisterska}
\\[2.5cm] 
{\Large Telemetryczny system do roweru\\[3cm] }
\end{center}
\begin{flushleft}
{\large Autor: Mateusz Trzeciak\\
Kierujący pracą: dr inż. Jerzy Fiołka
\\[3.3cm]Gliwice, marzec 2017}
\end{flushleft}
